...
public class NextDateTest
{
    ...
    private static JsonNode IniTestData_validDataBoundaryTest()
    {
        ...
        testDataSet.set("002",
                newObjectNode().put("out",100).set("in",newArrayNode().add(1900).add(4).add(14)));
        testDataSet.set("003",
                newObjectNode().put("out",100).set("in",newArrayNode().add(1901).add(4).add(14)));
        testDataSet.set("004",
                newObjectNode().put("out",100).set("in",newArrayNode().add(2099).add(4).add(14)));
        testDataSet.set("005",
                newObjectNode().put("out",100).set("in",newArrayNode().add(2100).add(4).add(14)));
        testDataSet.set("006",
                newObjectNode().put("out",101).set("in",newArrayNode().add(2101).add(4).add(14)));

        //月份非法， 期望返回错误码 errNoSuchDate = 102
        testDataSet.set("007",
                newObjectNode().put("out",102).set("in",newArrayNode().add(1994).add(0).add(14)));
        testDataSet.set("008",
                newObjectNode().put("out",100).set("in",newArrayNode().add(1994).add(1).add(14)));
        testDataSet.set("009",
                newObjectNode().put("out",100).set("in",newArrayNode().add(1994).add(2).add(14)));
        testDataSet.set("010",
                newObjectNode().put("out",100).set("in",newArrayNode().add(1994).add(11).add(14)));
        testDataSet.set("011",
                newObjectNode().put("out",100).set("in",newArrayNode().add(1994).add(12).add(14)));
        testDataSet.set("012",
                newObjectNode().put("out",102).set("in",newArrayNode().add(1994).add(13).add(14)));
    ...
    private static JsonNode IniTestData_getNextDateBoundaryInfoTest()
    {
